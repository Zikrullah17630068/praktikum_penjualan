                ...
                ?>
                    <tr>
                        ...
                        <form action method="POST">
                            ...
                            <a href="?page=barangdelete&id=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm" onClick="javascript: return confirm('Konfirmasi Data Barang akan dihapus?');"><i class="fa fa-trash"></i> Hapus</a>
                        </form>
