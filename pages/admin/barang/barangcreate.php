        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="?page=jenisbarangread">Data Barang</a></li>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST">
                ...
                <a href="?page=barangread" class="btn btn-danger btn-sm float-right"><i class="fa fa-times"></i> Batal</a>
